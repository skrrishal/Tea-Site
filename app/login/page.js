...
const Login = () => {
    ...
    return (
        <div className='text-white mx-auto py-14 container'>
            <h2 className='font-bold text-3xl text-center'>Login/Sign Up to get your fans Support</h2>
            ...
            <div className="social-login-buttons">
                ...
                <div className="flex flex-col gap-2 min-h-screen p-10 items-center">
                    ...
                    <button onClick={() => signIn("google")}
                        className="flex items-center w-[250px] bg-slate-50 text-black border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-slate-900 hover:text-white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
